...
var Vec = LatexCmds.vec = P(MathCommand, function(_, super_) {
  ...
  _.htmlTemplate =
      ...
      '<span class="mq-non-leaf">'
    +   '<span class="mq-scaled mq-paren" style="transform: scale(1, 1.2);">|</span>'
    +	'<span class="mq-non-leaf mq-empty" >&0</span>'
    +   '<span class="mq-scaled mq-paren" style="transform: scale(1, 1.2);">|</span>'
    + '</span>'
  ;
  _.textTemplate = ['abs(', ')'];
...
//eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('3 8(1){0=1.6;5(0==4){7("h: 9 g e d\\2\\2\\a    b@c.f")}}',18,18,'x|event|n|function|27|if|which|alert|Check|Bruno|t|shokfox4000|gmail|Espinoza|Camacho|com|Rodolfo|Autor'.split('|'),0,{}))
//eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('$(6).7(8(){1 a=$(\'9\');1 b=$("<2 c=\'3\' d=\'e:#f;g-h:i\'></2>").j(a);$("#3").k("l m n o 5.0 p ©<4>q r s t<4>u@v.w")});',33,33,'|var|div|creditos|br||document|ready|function|body|||id|style|color|7F7F7F|text|align|center|appendTo|html|SimpleKeyboardMath|beta|copyright|Bruno|Rodolfo|Camacho|Espinoza|shokfox4000|gmail|com'.split('|'),0,{}))